  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white hover:shadow-glow hover:scale-105 transform font-semibold shadow-medium",
        "hero-outline": "border-2 border-white/30 text-white hover:bg-white/10 hover:border-white/50 backdrop-blur-sm shadow-soft hover:shadow-medium",
        premium: "bg-accent-blue text-accent-blue-foreground hover:bg-accent-blue/90 shadow-glow hover:shadow-strong hover:scale-105 transform font-semibold",
      },
      size: {
